...
const id = usePage().props.product.id;
    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Once this product is deleted, all of its resources and data will
                be permanently deleted. Before deleting a product, please
        ...
        <Modal :show="confirmingProductDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Once this product is deleted, all of its resources and data
                    will be permanently deleted. Before deleting a product,
